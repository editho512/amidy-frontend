<template>
  <div :class="['col-span-2   bg-third  pt-4 pl-2 text-white flex flex-col justify-items-center gap-5 admin-sidebar max-lg:col-span-12 pb-3 ',
    ...
    <ItemSidebarAdminComponent :name="$t('sidebar.home')" url="home">
      <template v-slot:itemIcon>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="w-6 h-6">
          <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <ItemSidebarAdminComponent :name="$t('sidebar.notification')">
    ...
    <ItemSidebarAdminComponent name="Orders" url="order">
